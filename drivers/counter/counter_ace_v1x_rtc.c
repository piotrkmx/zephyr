...
#define DT_DRV_COMPAT intel_ace_rtc_counter
...
#define ACE_RTC_COUNTER_INIT(n)								\
	DEVICE_DT_INST_DEFINE(n, counter_ace_v1x_rtc_init, NULL, NULL, NULL,				\
				PRE_KERNEL_1, CONFIG_KERNEL_INIT_PRIORITY_DEFAULT,	\
				&ace_v1x_rtc_counter_apis);				

DT_INST_FOREACH_STATUS_OKAY(ACE_RTC_COUNTER_INIT)
